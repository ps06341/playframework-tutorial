...
public class EmployeeController extends Controller {
	 ...
	 */
	private Result GO_HOME = Results.redirect(routes.EmployeeController.list(0, "name", "asc", ""));
	...
	public CompletionStage<Result> list(Http.Request request, int page, String sortBy, String order, String filter) {
		...
		return employeeRepository.page(page, 10, sortBy, order, filter).thenApplyAsync(list -> {
			// This is the HTTP rendering thread context
			return ok(views.html.list2.render(list, sortBy, order, filter, request, messagesApi.preferred(request)));
